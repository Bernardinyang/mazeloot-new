                  ...
                  <SidebarMenuSubItem v-for="subItem in item.items" :key="subItem.title">
                    <SidebarMenuSubButton as-child size="sm">
                      <RouterLink
                        ...
                        :class="{
                          'bg-sidebar-accent text-sidebar-accent-foreground': isActiveRoute(subItem.url, subItem.name),
                        }"
                      >
          ...
          <SidebarMenuItem v-else>
            <SidebarMenuButton as-child :tooltip="item.title">
              <RouterLink
                ...
                :class="{
                  'bg-sidebar-accent text-sidebar-accent-foreground': isActiveRoute(item.url, item.name),
                }"
              >
                <component :is="item.icon" v-if="item.icon" />
                <span>{{ item.title }}</span>
