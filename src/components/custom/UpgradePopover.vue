<template>
  <Popover v-model:open="isOpen">
    <PopoverTrigger as-child>
      <Button
        size="sm"
        class="bg-teal-500/10 hover:bg-teal-500/20 text-teal-500 border-0"
      >
        <Rocket class="h-4 w-4 mr-1.5" />
        UPGRADE
      </Button>
    </PopoverTrigger>
    <PopoverContent class="w-[280px] max-w-[90vw] p-0 overflow-hidden" :class="[theme.bgCardSolid, theme.borderCard]" side="left" align="end" :side-offset="8">
      <div class="space-y-4">
        <!-- Image -->
