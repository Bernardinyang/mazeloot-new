...
/**
 * Reusable composable for calculating selection progress
 * Works with media items and sets to show selection counts
 */
export function useSelectionProgress(mediaItems, mediaSets) {
  /**
