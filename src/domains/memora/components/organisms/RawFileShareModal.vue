    ...
    <DialogContent :class="[theme.bgCard, theme.borderSecondary]" class="sm:max-w-[520px]">
      <DialogHeader>
        ...
        <DialogDescription :class="theme.textSecondary" class="text-sm mt-1">
          Share this rawFile with your client via link, QR code, WhatsApp, or email.
        </DialogDescription>
      </DialogHeader>
      ...
      <div class="space-y-6 mt-6">
        ...
        <div v-if="password" class="space-y-2">
          ...
          <p :class="theme.textSecondary" class="text-xs">
            Share this password with visitors to access this rawFile
          </p>
        </div>
        ...
        <div class="space-y-2">
          ...
          >
            ...
            <p :class="theme.textSecondary" class="text-xs text-center max-w-xs">
              Scan this QR code to access the rawFile
            </p>
          </div>
        </div>
...
const handleShareWhatsApp = () => {
  const message = encodeURIComponent(
    `Check out this rawFile: ${props.rawFileName}\n${shareLink.value}`
  )
...
const handleShareEmail = () => {
  const subject = encodeURIComponent(`RawFile: ${props.rawFileName}`)
  const body = encodeURIComponent(`Check out this rawFile:\n\n${shareLink.value}`)
...
const handleDownloadQR = () => {
  ...
  try {
    ...
    link.download = `rawFile-${props.rawFileId}-qr-code.png`
