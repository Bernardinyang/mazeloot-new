  ...
  >
    ...
    <div v-if="!props.isSidebarCollapsed" class="mb-6">
      ...
      <div
        ...
        class="w-full aspect-square rounded-2xl overflow-hidden bg-white/25 border-2 border-white/20 shadow-xl animate-pulse to-gray-200 dark:from-gray-800 dark:to-gray-900 shadow-xl border-2 animate-pulse"
      >
      ...
      <div
        ...
        class="w-full aspect-square rounded-2xl overflow-hidden flex items-center justify-center border-2 border-white/20 shadow-lg shadow-black/10 group cursor-pointer relative bg-primary-900/20"
      ...
      >
        <div class="text-center px-4 text-primary-foreground">
          <div
            class="p-5 rounded-2xl bg-white/20 dark:bg-white/15 mb-4 mx-auto w-fit"
          >
