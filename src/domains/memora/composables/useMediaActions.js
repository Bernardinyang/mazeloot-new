...
/**
 * Comprehensive media actions composable for selections, collections, proofing, and raw files
 * 
 * @param {Object} options
 * @param {string} options.contextType - 'selection' | 'collection' | 'proofing' | 'raw_files'
...
export function useMediaActions({
  contextType, // 'selection' | 'collection' | 'proofing' | 'raw_files'
  api,
