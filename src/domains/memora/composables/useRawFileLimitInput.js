...
/**
 * Composable for handling rawFile limit input validation and normalization
 * Provides reusable logic for converting user input to valid limit values
 */
export function useRawFileLimitInput(initialValue = null) {
  /**
   * Normalize a rawFile limit value
