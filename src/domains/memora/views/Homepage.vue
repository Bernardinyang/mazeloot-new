<template>
  <DashboardLayout>
    ...
    <ShareModal
      :open="showShareModal"
      :share-link="homepageUrl"
      title="Share Homepage"
      description="Share your homepage with others via link, QR code, WhatsApp, or email."
      link-label="Homepage Link"
      :password="homepagePassword"
      password-description="Share this password with visitors to access your homepage"
      :item-name="previewBranding.name"
      qr-code-description="Scan this QR code to access the homepage"
      download-file-name="homepage-qr-code.png"
