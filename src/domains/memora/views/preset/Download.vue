    ...
    >
      ...
      <div v-else class="space-y-8 max-w-3xl">
        ...
        >
          ...
          >
            <button
              :class="[showPhotoOptions ? 'text-accent bg-accent/10 dark:bg-accent/20' : '']"
                      ...
                      <div class="flex-1">
                        ...
                        >
                          <label class="flex items-center gap-2.5 cursor-pointer group/radio">
                            ...
                            />
                            <span
                              :class="formData.highResolutionSize === '3600px' ? 'text-accent' : ''"
                      ...
                      <div class="flex-1">
                        ...
                        >
                          <label class="flex items-center gap-2.5 cursor-pointer group/radio">
                            ...
                            />
                            <span
                              :class="formData.webSize === '2048px' ? 'text-accent' : ''"
                              class="text-sm font-medium transition-colors"
                              >2048px</span
                            >
                          </label>
                          <label class="flex items-center gap-2.5 cursor-pointer group/radio">
                            ...
                            />
                            <span
                              :class="formData.webSize === '1024px' ? 'text-accent' : ''"
                              class="text-sm font-medium transition-colors"
                              >1024px</span
                            >
                          </label>
                          <label class="flex items-center gap-2.5 cursor-pointer group/radio">
                            ...
                            />
                            <span
                              :class="formData.webSize === '640px' ? 'text-accent' : ''"
                              class="text-sm font-medium transition-colors"
                              >640px</span
                            >
                          </label>
        ...
        >
          ...
          <div class="flex items-center gap-3 max-w-md">
            ...
            >
              <RefreshCw class="h-4 w-4 mr-2 group-hover:text-accent transition-colors" />
              Generate
            </Button>
          </div>
        </div>
...
import { ArrowLeft, ArrowRight, ChevronDown, Info, RefreshCw } from '@/shared/utils/lucideAnimated'
...
const loadPresetData = () => {
  if (currentPreset.value && !isLoadingData.value) {
    ...
    const loadedData = {
      ...
      webSizeEnabled: webSize.enabled !== undefined ? webSize.enabled : defaultWebSizeEnabled,
