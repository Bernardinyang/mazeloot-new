          ...
          <div class="flex items-start justify-between gap-4">
            <div class="flex-1">
              ...
              <p :class="theme.textSecondary" class="text-sm leading-relaxed">
                If enabled, all collections created from this preset will have password protection
                enabled. The actual password will be set when creating each collection.
              </p>
            </div>
