          ...
          <div class="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 sm:gap-6">
            ...
            <div class="flex-shrink-0 w-full sm:w-auto">
              <Button
                ...
                class="w-full sm:w-auto px-6 sm:px-8 py-4 sm:py-6 text-sm sm:text-base md:text-lg font-medium tracking-wider uppercase border backdrop-blur-sm transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
