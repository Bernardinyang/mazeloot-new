...
import { useSettingsApi } from '@/shared/api/settings'
import { useSocialLinksApi } from '@/shared/api/socialLinks'
...
onMounted(async () => {
  ...
  try {
    ...
    try {
      const { useCollectionsApi } = await import('@/shared/api/collections')
