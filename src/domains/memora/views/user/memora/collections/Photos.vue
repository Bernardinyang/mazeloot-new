...
import { useWatermarkStore } from '@/shared/stores/watermark'
...
import TagModal from '@/domains/memora/modals/TagModal.vue'
import EditFilenamesModal from '@/domains/memora/modals/EditFilenamesModal.vue'
import BulkWatermarkModal from '@/domains/memora/modals/BulkWatermarkModal.vue'
import ReplacePhotoModal from '@/domains/memora/modals/ReplacePhotoModal.vue'
import WatermarkMediaModal from '@/domains/memora/modals/WatermarkMediaModal.vue'
import WatermarkPreviewModal from '@/domains/memora/modals/WatermarkPreviewModal.vue'
...
import { createThumbnail } from '@/shared/utils/media/createThumbnail'
import { formatMediaDate } from '@/shared/utils/media/formatMediaDate'
import { getFileBaseName } from '@/shared/utils/media/getFileBaseName'
import { triggerFileInputClick } from '@/shared/utils/media/triggerFileInputClick'
import { getCollectionShareLink } from '@/shared/utils/media/getCollectionShareLink'
import { getMediaShareUrl } from '@/shared/utils/media/getMediaShareUrl'
import { getMediaDownloadUrl } from '@/shared/utils/media/getMediaDownloadUrl'
import { getDownloadFilename } from '@/shared/utils/media/getDownloadFilename'
import { fetchDownloadBlob } from '@/shared/utils/media/fetchDownloadBlob'
import { triggerBrowserDownload } from '@/shared/utils/media/triggerBrowserDownload'
import { triggerFallbackDownloadLink } from '@/shared/utils/media/triggerFallbackDownloadLink'
import { copyTextToClipboard } from '@/shared/utils/clipboard/copyTextToClipboard'
import { useCollectionWorkflow } from '@/shared/composables/useCollectionWorkflow'
// Media Sets sidebar is store-driven (Option B)
import { useBulkMoveToSetFlow } from '@/shared/composables/useBulkMoveToSetFlow'
import { useMoveCopyFlow } from '@/shared/composables/useMoveCopyFlow'
import { useBulkWatermarkFlow } from '@/shared/composables/useBulkWatermarkFlow'
import { useBulkTagFlow } from '@/shared/composables/useBulkTagFlow'
import { useMediaShareDownloadActions } from '@/shared/composables/useMediaShareDownloadActions'
import { useMediaWatermarkActions } from '@/shared/composables/useMediaWatermarkActions'
import { useCollectionCoverActions } from '@/shared/composables/useCollectionCoverActions'
import { useMediaViewerFlow } from '@/shared/composables/useMediaViewerFlow'
import { useMediaSelectionFlow } from '@/shared/composables/useMediaSelectionFlow'
import { useCollectionLoadFlow } from '@/shared/composables/useCollectionLoadFlow'
import { useAsyncPagination } from '@/shared/composables/useAsyncPagination'
import { useMediaActions } from '@/shared/composables/useMediaActions'
...
import { getMediaFilename } from '@/shared/utils/media/getMediaFilename'
import { createThumbnailFromDataURL } from '@/shared/utils/media/createThumbnailFromDataURL'
import { useCollectionMediaSetsSidebarStore } from '@/shared/stores/collectionMediaSetsSidebar'
