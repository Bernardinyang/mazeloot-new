    ...
    try {
      ...
      return {
        user: {
          ...
          memora_capabilities: response.data.user.memora_capabilities ?? {},
          set_limit_per_phase: response.data.user.set_limit_per_phase ?? null,
          watermark_limit: response.data.user.watermark_limit ?? null,
          preset_limit: response.data.user.preset_limit ?? null,
