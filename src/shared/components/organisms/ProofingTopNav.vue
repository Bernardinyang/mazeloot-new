...
const handlePreview = async () => {
  ...
  // Generate preview URL using new format: /memora/:domainOrUsername/proofing/:id
  const proofingId = proofing.value.id || proofing.value.uuid
  const previewUrl = `${window.location.origin}/memora/${domain}/proofing/${proofingId}?preview=true`
