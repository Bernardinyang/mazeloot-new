<template>
  ...
  >
    ...
    <div
      class="absolute top-0 right-0 w-32 h-32 bg-blue-500/20 dark:bg-blue-500/30 rounded-full blur-3xl -mr-16 -mt-16"
    ></div>
    <div
      class="absolute bottom-0 left-0 w-24 h-24 bg-purple-500/20 dark:bg-purple-500/30 rounded-full blur-2xl -ml-12 -mb-12"
    ></div>
      ...
      <CardContent class="p-6 relative z-10">
        <div class="flex flex-col items-center gap-5">
          ...
          <div class="relative">
            <!-- Outer glow ring -->
            <div
              class="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500/40 via-purple-500/40 to-pink-500/40 blur-xl animate-pulse"
            ></div>
            <!-- Avatar container -->
            <div
              :class="[
            ...
            >
              ...
              <!-- Status indicator -->
              <div
                class="absolute bottom-0 right-0 w-4 h-4 bg-green-500 rounded-full border-2 border-white dark:border-gray-900 shadow-lg"
              ></div>
            </div>
          </div>
          ...
          <div class="flex flex-col gap-2 w-full mt-2">
            ...
            <Button
              ...
              @click="$emit('logout')"
            >
              <LogOut class="h-4 w-4 transition-transform duration-300 group-hover:translate-x-1" />
              <span>Sign Out</span>
            </Button>
          </div>
        </div>
