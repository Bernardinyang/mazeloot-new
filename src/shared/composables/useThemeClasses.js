...
export function useThemeClasses() {
  ...
  const textPrimary = 'text-white dark:text-gray-100 light:text-gray-900'
  const textSecondary = 'text-white/90 dark:text-gray-300 light:text-gray-600'
  const textTertiary = 'text-white/70 dark:text-gray-400 light:text-gray-500'
  ...
  const bgButtonHover = 'hover:bg-white/15 dark:hover:bg-gray-700/80 light:hover:bg-gray-100'
  ...
  const borderPrimary = 'border-white/20 dark:border-gray-600/60 light:border-gray-200'
  const borderSecondary = 'border-gray-600 dark:border-gray-600 light:border-gray-200'
  const borderCard = 'border-white/25 dark:border-gray-600/70 light:border-gray-300'
  ...
  const borderInput = 'border-white/20 dark:border-gray-600/60 light:border-gray-300'
  const textInput = 'text-white dark:text-gray-100 light:text-gray-900'
  const placeholderInput =
    'placeholder:text-white/60 dark:placeholder:text-gray-500 light:placeholder:text-gray-400'
