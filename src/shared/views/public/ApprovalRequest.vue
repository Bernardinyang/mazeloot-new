<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950">
    ...
    <template v-else>
      ...
      <div v-else-if="approvalRequest" class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <!-- Header -->
              ...
              <div class="space-y-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                  <Button
                    ...
                    class="flex-1 bg-green-600 hover:bg-green-700 text-white text-sm sm:text-base"
                    @click="handleApprove"
                  >
