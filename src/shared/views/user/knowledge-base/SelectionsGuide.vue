<template>
  <KnowledgeBaseLayout>
    <div class="space-y-8">
      <!-- Hero Section -->
      <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-yellow-500 via-amber-500 to-orange-500 p-4 sm:p-8 md:p-12 shadow-2xl border-2 border-yellow-400/30">
      ...
      <!-- Overview Section -->
      <Card class="p-4 sm:p-6 border-2 border-yellow-200 dark:border-yellow-800 bg-gradient-to-br from-yellow-50/50 to-orange-50/50 dark:from-yellow-950/30 dark:to-orange-950/30">
        <div class="space-y-4">
      ...
      <div class="grid gap-6">
        <Card 
          ...
          :key="section.id" 
          class="group p-4 sm:p-6 space-y-4 border-2 hover:border-yellow-300 dark:hover:border-yellow-700 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
