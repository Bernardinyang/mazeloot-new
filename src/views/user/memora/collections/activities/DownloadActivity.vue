                ...
                <tbody :class="theme.borderSecondary" class="divide-y">
                  ...
                  >
                    ...
                    <td class="px-6 py-4">
                      ...
                      >
                        {{ activity.downloadType === 'full' ? 'Full Size' : 'Web Size' }}
                      </span>
                    </td>
                    <td class="px-6 py-4">
...
// Activity data
const activities = ref<DownloadActivity[]>([])
...
// Generate demo data
const generateDemoData = (): DownloadActivity[] => {
  const now = new Date()
  const demoActivities: DownloadActivity[] = []
  ...
  const demoPhotos = [
    ...
    { name: 'IMG_009.jpg', thumbnail: 'https://picsum.photos/seed/photo9/200/200' },
    { name: 'IMG_010.jpg', thumbnail: 'https://picsum.photos/seed/photo10/200/200' },
    { name: 'IMG_011.jpg', thumbnail: 'https://picsum.photos/seed/photo11/200/200' },
    { name: 'IMG_012.jpg', thumbnail: 'https://picsum.photos/seed/photo12/200/200' },
  ]
  ...
  const downloadTypes: ('full' | 'web')[] = ['full', 'web']
...
onMounted(async () => {
  ...
  try {
    ...
    // TODO: Fetch download activities from API
...
const exportData = () => {
  ...
  console.log('Exporting download activity data...')
}
</script>
