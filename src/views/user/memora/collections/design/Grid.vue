          ...
          <div class="flex items-start justify-between mb-4">
            <div>
              <div class="flex items-center gap-3 mb-2">
                <h1 class="text-3xl font-bold" :class="theme.textPrimary">Grid</h1>
                <Transition
            ...
            <div class="hidden md:flex gap-4">
              ...
              >
                <div class="text-xs" :class="theme.textTertiary">Grid Style</div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 h-[calc(100vh-12rem)]">
          ...
          <div class="lg:col-span-2 flex flex-col min-h-0">
            <div class="flex-1 overflow-y-auto space-y-12 pr-2 min-h-0">
              ...
              >
                <div class="mb-2">
                  <h3 class="text-lg font-bold mb-1.5" :class="theme.textPrimary">Grid Layout</h3>
...
import { Check, Loader2, Grid3x3, LayoutGrid, ExternalLink, ImageIcon } from 'lucide-vue-next'
