          ...
          <div class="space-y-6">
            ...
            >
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  <h3 class="text-lg font-bold mb-2" :class="theme.textPrimary">
                    Preset Favorite Lists
                  </h3>
                  <p class="text-sm mb-4 leading-relaxed" :class="theme.textSecondary">
...
import { Settings, Lock, Download, Heart, Loader2, Info } from 'lucide-vue-next'
