    ...
    <div class="space-y-6">
      ...
      <div class="w-[50%]">
        ...
        <p class="text-sm mb-4" :class="theme.textSecondary">
          Customize your brand identity, logo, colors, and visual elements for your client
          galleries.
        </p>
      ...
      <div class="space-y-6 w-[50%]">
        ...
        <div class="space-y-2">
          ...
          <p class="text-xs" :class="theme.textSecondary">
            Your client galleries and mobile gallery apps are always available with your default
            site address. To change your default domain, edit your username under
        ...
        <div class="space-y-2">
          ...
          />
          <p class="text-xs" :class="theme.textSecondary">
            Use your own custom domain for your client galleries. This feature is available with an
            upgraded account.
        ...
        <!-- Upgrade Section -->
        <div
          class="w-full rounded-lg border p-6 space-y-6"
          :class="[theme.bgCard, theme.borderCard]"
        >
          <div class="flex items-center justify-between">
            <h3 class="font-semibold uppercase text-sm" :class="theme.textPrimary">
              Upgrade for more brand control
            </h3>
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="flex-1">
                <p class="text-sm" :class="theme.textSecondary">
                  Your logo will be used in place of the text logo and profile icon, including on
                  the white background of your homepage. For the cover logo, use a light/white logo
                  with a transparent background for best display.
                  <a href="#" class="text-teal-500 hover:text-teal-600 underline">Learn more</a>.
                </p>
              </div>
            </div>
        ...
        <div class="flex items-center justify-between py-4">
          ...
          >
            ...
            <span
              ...
              :class="showPixiesetBranding ? theme.textPrimary : theme.textSecondary"
            >
